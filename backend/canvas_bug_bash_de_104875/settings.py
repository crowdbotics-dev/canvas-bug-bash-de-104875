"""
Django settings for canvas_bug_bash_de_104875 project.
...
ROOT_URLCONF = 'canvas_bug_bash_de_104875.urls'
...
WSGI_APPLICATION = 'canvas_bug_bash_de_104875.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "canvas_bug_bash_de_104875 API",
    "DESCRIPTION": "API documentation for canvas_bug_bash_de_104875 App",
    "VERSION": "v1",
}
